...
# === OMEGA SAFE MODULE GUARD ===
try:
    import omega_lead_ingest
except Exception:
    pass
# ===============================
...
# === OMEGA AUTO LEAD INGEST ===
try:
    from omega_lead_ingest import ingest_leads_to_queue
    _lead_count = ingest_leads_to_queue()
    log.info(f"[AUTO-LEADS] Ingested: {_lead_count}")
except Exception as e:
    log.error(f"[AUTO-LEADS ERROR] {e}")
# ================================
